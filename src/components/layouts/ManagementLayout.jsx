  ...
  return (
    <div className="flex h-screen bg-neutral-lightest">
      ...
      >
        ...
        {sidebarOpen && (
          <div className="px-4 py-3 bg-purple-50 border-b border-purple-100">
            <div className="text-purple-800 font-medium">Management Dashboard</div>
          </div>
        )}
      ...
      <div className={`flex flex-col flex-1 overflow-hidden transition-all duration-300 ${sidebarOpen ? 'ml-64' : 'ml-20'}`}>
        <TopBar sidebarOpen={sidebarOpen} setSidebarOpen={setSidebarOpen} dashboardName="Management" />
    ...
    <NavLink
      ...
      className={({ isActive }) => 
        ...
        ${isActive 
          ...
          : 'text-neutral-dark hover:bg-neutral-lightest hover:text-purple-500'
        }`
      }
      end={to === '/management'}
    >
